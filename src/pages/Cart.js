...
const styles = {
    ...
    removeBtn: { border: 'none', background: 'none', fontWeight: 'bold', color: '#212121', fontSize: '13px', padding: '10px 0 0', cursor: 'pointer' },
    ...
    shopNowBtn: { background: '#2874f0', color: '#fff', border: 'none', padding: '10px 30px', marginTop: '15px', fontWeight: 'bold', cursor: 'pointer' },
    successScreen: { textAlign: 'center', padding: '80px 20px', background: '#fff', minHeight: '100vh' },
    viewOrdersBtn: { background: '#fff', color: '#2874f0', border: '1px solid #e0e0e0', padding: '10px 30px', fontWeight: 'bold', cursor: 'pointer' }
};
